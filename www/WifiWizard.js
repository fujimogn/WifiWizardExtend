...
var WifiWizard = {
    ...
    getCurrentNetwork: function(win, fail) {
        if (typeof win != "function") {
            console.log("getCurrentNetwork first parameter must be a function to handle network.");
            return;
        }
        cordova.exec(win, fail, 'WifiWizard', 'getConnectedNetwork', []);
    },
